			...
			<div className="h-auto md:pt-[50px] md:mb-[20px] mx-auto relative">
				<div className=" px-[10px] z-[999] h-full md:justify-center flex flex-col mx-auto w-full rounded-[20px] ">
					...
					<motion.h2
						...
						transition={{ duration: 1, type: "spring", bounce: 0.6 }}
						viewport={{ once: true, amount: 0.5 }}
						className={`lg:text-[60px] md:text-[50px] text-[40px] leading-[1.2em] font-[700] mb-8 text-center   text-primary-black  `}>
					...
					<motion.p
						...
						viewport={{ once: true, amount: 0.5 }}
						className="text-[25px] leading-loose text-primary-black font-[400] text-center mx-auto md:w-[70%] lg:w-[46%] w-[90%]">
						Your creativity knows no boundary. Neither should the resources to bring it to life. Fig Finance gives you the financial freedom to focus on what matters (your content, your passion, and your projects.)
					</motion.p>
					<motion.div
						initial={{ opacity: 0, y: 50 }}
						whileInView={{ opacity: 1, y: 0 }}
